...
SELECT
CONCAT(SEX,AGE_BAND_10Y,ETHNICITY_SUBCATEGORY,MAIN_LANGUAGE,BASE.PRACTICE_CODE) AS KEYID,
SEX AS GENDER,
AGE_BAND_10Y,
AGE_BAND_5Y,
...
COUNT(DISTINCT BASE.PERSON_ID) AS PATIENT_COUNT
...
-- WHERE BOROUGH_REGISTERED IN ('Camden','Enfield','Islington','Barnet','Haringey') -- we filter this out in base layer
