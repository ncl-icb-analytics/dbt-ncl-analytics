...
with inclusion_list as (
    select patient_id, olids_id, fragmented_sk_patient_id_flag, fragmented_person_id_flag, area_code, area_name, practice_code, practice_name, age, main_language, gender, ethnicity_category -- reduce to one GP per patient
