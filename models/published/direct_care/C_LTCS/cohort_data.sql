...
with inclusion_list as (
    select patient_id, olids_id, fragmented_sk_patient_id_flag, fragmented_person_id_flag, pcn_code, pcn_name, practice_code, practice_name, age, main_language -- reduce to one GP per patient
