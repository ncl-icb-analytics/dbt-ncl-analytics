-- Raw layer model for aic.BASE_SUS__APC_SPELL_COMMISSIONING_GROUPING_UNBUNDLED_HRG
...
from {{ source('aic', 'BASE_SUS__APC_SPELL_COMMISSIONING_GROUPING_UNBUNDLED_HRG') }}
