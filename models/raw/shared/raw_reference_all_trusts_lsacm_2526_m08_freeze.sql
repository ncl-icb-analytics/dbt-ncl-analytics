...
select
    ...
    "dv_RecipientCode" as dv_recipient_code,
    "Rowid##" as rowid,
    "Fileid##" as fileid
from {{ source('reference_analyst_managed', 'ALL_TRUSTS_LSACM_2526_M08_FREEZE') }}
