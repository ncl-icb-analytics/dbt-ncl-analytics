-- Raw layer model for aic.STG_SUS__APC_PROCEDURE_OPCS4
-- Source: "DATA_LAKE__NCL"."AIC_DEV"
-- Description: AIC pipelines
-- This is a 1:1 passthrough from source with standardized column names
select
    "APC_PROCEDURE_ID" as apc_procedure_id,
    "SK_PATIENT_ID" as sk_patient_id,
    "SPELL_ID" as spell_id,
    "OPCS_ORDER" as opcs_order,
...
from {{ source('aic', 'STG_SUS__APC_PROCEDURE_OPCS4') }}
