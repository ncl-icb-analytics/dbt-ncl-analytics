-- Raw layer model for reference_analyst_managed.TURNAROUND_TIMES_RAW_WRITE_TEST_BACKUP
...
from {{ source('reference_analyst_managed', 'TURNAROUND_TIMES_RAW_WRITE_TEST_BACKUP') }}
