...
select
    ...
    "PHASING_CODE" as phasing_code,
    "PHASING_DESCRIPTION" as phasing_description,
    "REGION" as region,
    "FILE_NAME" as file_name,
    "WORKSHEET" as worksheet
from {{ source('reference_analyst_managed', 'FA__MONTHLY_IAP_2526_GOSH_NEW_NCL_ONLY') }}
