...
select
    ...
    "CONTRACT_MONITORING_ADDITIONAL_DETAIL_(FIRST)" as contract_monitoring_additional_detail_first,
    "CONTRACT_MONITORING_ADDITIONAL_DESCRIPTION_(FIRST)" as contract_monitoring_additional_description_first,
...
from {{ source('reference_analyst_managed', 'FA__MONTHLY_IAP_2526_UCLH_160725') }}
