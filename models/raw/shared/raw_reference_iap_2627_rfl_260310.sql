...
select
    ...
    "COMMISSIONER_GROUPING" as commissioner_grouping,
    "ICB_CODE" as icb_code,
    "ICB_DESCRIPTION" as icb_description
from {{ source('reference_analyst_managed', 'IAP_2627_RFL_260310') }}
