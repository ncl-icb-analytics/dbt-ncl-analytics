...
select
    ...
    "MHS605UniqID" as mhs605_uniq_id,
    ...
    "MasterSnomedCTSecDiagCode" as master_snomed_ct_sec_diag_code,
...
from {{ source('mhsds', 'MHS605SecDiag') }}
