...
select
    ...
    "ADMITTED_NONADMITTED" as admitted_nonadmitted,
    ...
    "NETWORK" as network,
    "LOCAL_SUBSPECIALTY" as local_subspecialty,
    "FUTURE_BOOKED_OP_DATE" as future_booked_op_date
from {{ source('ptl', 'PTL_WEEKLY_DATA') }}
