{{
    config(
        description="Raw layer (Mental Health Services Data Set (MHSDS)). 1:1 passthrough with cleaned column names. \nSource: DATA_LAKE.MHSDS.MHS511AbsenceWithoutLeave \ndbt: source(''mhsds'', ''MHS511AbsenceWithoutLeave'') \nColumns:\n  SK -> sk\n  WardStayId -> ward_stay_id\n  StartDateMHAbsWOLeave -> start_date_mh_abs_wo_leave\n  StartTimeMHAbsWOLeave -> start_time_mh_abs_wo_leave\n  EndDateMHAbsWOLeave -> end_date_mh_abs_wo_leave\n  EndTimeMHAbsWOLeave -> end_time_mh_abs_wo_leave\n  MHAbsWOLeaveEndReason -> mh_abs_wo_leave_end_reason\n  RecordNumber -> record_number\n  MHS511UniqID -> mhs511_uniq_id\n  OrgIDProv -> org_id_prov\n  Person_ID -> person_id\n  UniqSubmissionID -> uniq_submission_id\n  UniqServReqID -> uniq_serv_req_id\n  UniqWardStayID -> uniq_ward_stay_id\n  UniqHospProvSpellID -> uniq_hosp_prov_spell_id\n  UniqHospProvSpellNum -> uniq_hosp_prov_spell_num\n  UniqMonthID -> uniq_month_id\n  RecordStartDate -> record_start_date\n  RecordEndDate -> record_end_date\n  AWOLDaysEndRP -> awol_days_end_rp\n  EFFECTIVE_FROM -> effective_from\n  UniqWardCode -> uniq_ward_code\n  RowNumber -> row_number\n  dmicImportLogId -> dmic_import_log_id\n  dmicSystemId -> dmic_system_id\n  dmicCCGCode -> dmic_ccg_code\n  dmicDateAdded -> dmic_date_added\n  FileType -> file_type\n  ReportingPeriodStartDate -> reporting_period_start_date\n  ReportingPeriodEndDate -> reporting_period_end_date\n  dmicDataset -> dmic_dataset"
    )
}}
select
    "SK" as sk,
