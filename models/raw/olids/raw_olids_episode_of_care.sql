...
select
    ...
    "LDS_DATETIME_SOURCE_RECORD_ACQUIRED" as lds_datetime_source_record_acquired,
    "LDS_DATETIME_SOURCE_RECORD_UPDATED" as lds_datetime_source_record_updated,
