...
select
    ...
    "DATE_PRECISION_RAW" as date_precision_raw,
    ...
    "RESULT_MEASUREMENT_UNITS_SOURCE_CONCEPT_ID" as result_measurement_units_source_concept_id,
