...
select 
    ...
    , core.appointment_care_location_site_code_of_treatment as location_id
    ...
    , core.appointment_referral_priority_type as acuity
    , core.appointment_care_professional_treatment_function as primary_treatment
    , 'SUS_OP' as source
    , core.appointment_commissioning_grouping_core_hrg as type
