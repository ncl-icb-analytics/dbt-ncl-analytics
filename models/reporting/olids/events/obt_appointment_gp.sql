...
where CONTEXT_TYPE = 'Care Related Encounter' -- Coverage is good, needs review by dataset expert. Would recommend reviewing national slot appointment_type and appointment_type more to further refine, and consider pulling any relevant seeming slots from other contexts