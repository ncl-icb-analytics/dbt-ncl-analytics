...
WITH indicator_population AS (
    ...
    WHERE diabetes.is_on_register
        AND frailty.latest_frailty_severity IN ('Moderate', 'Severe')
...
SELECT
    person_id,
    'IND180' AS indicator_id,
    'Diabetes: HbA1c 75 mmol/mol' AS indicator_name,
    CURRENT_DATE() AS reporting_date,
    DATEADD(month, -12, CURRENT_DATE()) AS measurement_period_start,
    age,
    'Diabetes with moderate or severe frailty' AS condition_name,
