...
--THIS TABLE CAPTURES RSV FOR THE ADULT IMMS POPULATION AGED 65 AND OVER. IT DOES NOT INCLUDE RSV ROUTINE MATERNITY VACCINATIONS.
WITH
...
eligible AS (
    ...
    where age >= 75 or IS_CARE_HOME_RESIDENT 
)
-- RSV SINGLE DOSE
,rsv as (
select *
