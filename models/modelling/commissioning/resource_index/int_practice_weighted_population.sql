-- Practice need-weighted population by allocation base year, from UKHFD.
-- weighted_patients is the mean of the six service-specific weighted
-- populations used in Core WP.xlsx: G&A, community, mental health, maternity,
-- prescribing and primary medical care. Health inequalities and the supplied
-- Core Services aggregate are not included in that mean.
