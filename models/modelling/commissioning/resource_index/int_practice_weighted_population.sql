...
-- NHS Payments to General Practice (annual, FY 2015/16 onwards). The weighted
-- denominator for the Carr-Hill resource index basis.
--
-- weighted_to_registered_ratio > 1 = the practice's population has a higher
-- Carr-Hill weighted list than its raw list implies (age-sex workload,
