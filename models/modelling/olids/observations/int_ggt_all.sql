...
/*
All GGT (gamma-glutamyl transferase) observations with unit standardisation and data quality flags.
...
WITH raw_observations AS (
    SELECT *
    FROM ({{ get_observations("'GGT_LFT_COD'") }})
),
