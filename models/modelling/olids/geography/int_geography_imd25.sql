...
Based on IMD 2025 data which uses 2021 LSOA boundaries.
*/

WITH imd_2025_data AS (
    -- IMD 2025 reference data
  SELECT
        lsoacode AS lsoa_code_2021,
        imddecile AS imd_decile
    FROM {{ ref('stg_reference_imd2025') }}
    --FROM MODELLING.DBT_STAGING.STG_REFERENCE_IMD2025
