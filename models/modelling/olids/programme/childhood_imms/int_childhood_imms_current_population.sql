...
,dem.AGE 
,age.AGE_DAYS_APPROX
,CASE WHEN dem.BIRTH_DATE_APPROX >= '2022-09-01' AND dem.BIRTH_DATE_APPROX < '2024-07-01' THEN 'Yes'
ELSE 'No' END AS BORN_SEP_2022_FLAG
,CASE WHEN dem.BIRTH_DATE_APPROX >= '2024-07-01' AND dem.BIRTH_DATE_APPROX < '2025-01-01' THEN 'Yes'
