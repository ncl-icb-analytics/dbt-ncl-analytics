...
WHEN VACCINE_ID in ('6IN1_4') AND (BORN_JUL_2024_FLAG = 'No' OR BORN_JAN_2025_FLAG = 'No' OR BORN_SEP_2022_FLAG = 'No') THEN 'No' 
WHEN VACCINE_ID in ('6IN1_4') AND BORN_SEP_2022_FLAG = 'Yes' THEN 'No'
WHEN VACCINE_ID in ('MMRV_1B','MMRV_2B') AND BORN_JUL_2024_FLAG = 'Yes' THEN 'Yes' 
WHEN VACCINE_ID in ('MMRV_1B','MMRV_2B') AND BORN_JUL_2024_FLAG = 'No' THEN 'No'
...
WHEN VACCINE_ID not in ('6IN1_4','MMRV_1B','MMRV_2B','MMRV_1','MMRV_2','MMRV_1C') THEN 'No'
ELSE 'Yes' END AS NEW_VACCINE_APPLICABLE
from ELIG