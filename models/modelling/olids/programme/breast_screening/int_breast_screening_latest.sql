...
/*
Latest breast screening status per person (completed or declined).
Simple QUALIFY-based latest record selection from int_breast_screening_all.
...
Used for breast screening programme analysis and current status determination.
*/
