...
CASE WHEN ARAF.LATEST_NEW_ARAF_DATE IS NOT NULL THEN 'Yes ('|| CAST(ARAF.LATEST_NEW_ARAF_DATE AS VARCHAR(100)) ||')' ELSE 'No' END AS NEW_ANNUAL_RISK_ACKNOWLEDGEMENT_FORM_INFO,
MAX(CASE WHEN ARAF.LATEST_NEW_ARAF_DATE IS NOT NULL THEN TO_VARCHAR(ARAF.LATEST_NEW_ARAF_DATE, 'DD/MM/YYYY') END) AS NEW_ARAF_DATE,
