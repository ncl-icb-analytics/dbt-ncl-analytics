/*
Simplified Asthma Admission Eligibility Rule
...
-- Step 1: Find people with asthma admission codes (for all campaigns)
people_with_asthma_admission AS (
    SELECT 
        cc.campaign_id,
        obs.person_id,
...
final_eligibility AS (
    SELECT 
        ...
        'People with asthma hospital admission codes' AS description,
        ...
        aa.audit_end_date AS created_at
    FROM people_with_asthma_admission aa
    JOIN all_campaigns cc
        ON aa.campaign_id = cc.campaign_id
