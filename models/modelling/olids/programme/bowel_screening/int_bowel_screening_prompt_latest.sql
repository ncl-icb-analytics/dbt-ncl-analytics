...
/*
Latest bowel screening prompt per person.
Simple QUALIFY-based latest record selection from int_bowel_screening_prompt_all.
...
SELECT
    ...
    concept_code,
    concept_display
FROM {{ ref('int_bowel_screening_prompt_all') }}
