...
WHEN ec.VACCINE_ID in ('SHING_1B','SHING_2B','SHING_1C','SHING_2C') AND ec.TURN_65_AFTER_SEP_2023 AND ve.EVENT_DATE IS NULL THEN 'Not applicable'
...
WHEN ec.VACCINE_ID in ('SHING_1','SHING_2','SHING_1C','SHING_2C')  AND ec.TURN_65_AFTER_SEP_2023 = FALSE  AND ve.EVENT_DATE IS NULL THEN 'Not applicable'
--SHING 1C AGED 18+ IMMUNOSUPRESSED
WHEN ec.IS_IMMUNOSUPPRESSED AND ec.AGE >= 18 AND ec.VACCINE_ID in ('SHING_1C','SHING_2C') AND ve.EVENT_DATE IS NULL AND ec.ELIGIBLE_FROM_DATE <= CURRENT_DATE AND ec.currently_eligible THEN 'Overdue'
WHEN ec.IS_IMMUNOSUPPRESSED AND ec.AGE >= 18 AND ec.VACCINE_ID in ('SHING_1C','SHING_2C') AND ve.EVENT_DATE IS NULL AND ec.currently_eligible = FALSE AND ec.AGE_DAYS_APPROX <= ec.maximum_age_days THEN 'Not due yet'
WHEN ec.VACCINE_ID in ('SHING_1','SHING_2','SHING_1B','SHING_2B') AND ec.IS_IMMUNOSUPPRESSED AND ec.AGE >= 18 AND ve.EVENT_DATE IS NULL THEN 'Not applicable'
--RSV------------------------------------------------------------
...
WHEN ec.VACCINE_ID in ('RSV_1B','RSV_1C')  AND ec.IS_CARE_HOME_RESIDENT = FALSE AND ve.EVENT_DATE IS NULL THEN 'Not applicable'
...
WHEN ec.VACCINE_ID in ('RSV_1','RSV_1C')  AND ec.IS_CARE_HOME_RESIDENT AND ve.EVENT_DATE IS NULL THEN 'Not applicable'
--RSV_1C CURRENTLY PREGNANT 
WHEN ec.VACCINE_ID in ('RSV_1C')  AND ec.IS_PREGNANT AND ve.EVENT_DATE IS NULL AND ec.ELIGIBLE_FROM_DATE < CURRENT_DATE AND ec.currently_eligible THEN 'Overdue'
WHEN ec.VACCINE_ID in ('RSV_1C')  AND ec.IS_PREGNANT AND ve.EVENT_DATE IS NULL AND ec.currently_eligible = FALSE AND ec.AGE_DAYS_APPROX <= ec.maximum_age_days THEN 'Not due yet'
WHEN ec.VACCINE_ID in ('RSV_1,RSV_1B')  AND ec.IS_PREGNANT AND ve.EVENT_DATE IS NULL THEN 'Not applicable'
---PPV------------------------------------------------------------------------
