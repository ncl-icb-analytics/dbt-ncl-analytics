...
SELECT 
    ...
    ON v1.PERSON_ID = v2.PERSON_ID AND v2.VACCINE_ID in ('SHING_2','SHING_2B') AND v2.VACCINATION_STATUS in ('Completed', 'OutofSchedule')  
    AND v1.VACCINATION_DATE <> v2.VACCINATION_DATE
    WHERE v1.VACCINE_ID in ('SHING_1','SHING_1B') and v1.VACCINATION_STATUS in ('Completed', 'OutofSchedule')  