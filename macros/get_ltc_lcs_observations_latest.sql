{% macro get_ltc_lcs_observations_latest(valueset_ids=none, valueset_friendly_names=none) %}

{%- if valueset_ids is none and valueset_friendly_names is none -%}
    {{ exceptions.raise_compiler_error("get_ltc_lcs_observations_latest requires either valueset_ids or valueset_friendly_names parameter") }}
{%- endif -%}
