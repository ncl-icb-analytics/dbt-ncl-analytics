...
Report title: [ICB_CF_CKD_UACR_62] Requires UACR check
Folder: 1) Casefinding R2 > [CF-CKD] CKD Case finding
Source: NCL LTC LCS R5.0 updated: 27112025
Description: UACR not done in the last 12 months
...
- **Criterion A — Clinical Codes** (clinical events)
  - Code in: `requires_uacr_check_vs1` (1 code)
...
| ICB_CF_CKD_UACR_62 | `requires_uacr_check_vs1` |  | 1 | SNOMED | 1 | Urine albumin:creatinine ratio | 71e284a5 |
