...
Report title: [ICB_CF_CKD_64_1N] Requires review of CKD coding
Folder: 1) Casefinding R2 > [CF-CKD] CKD Case finding
Source: NCL LTC LCS R5.0 updated: 27112025

## What this search does

Start with the patients found by "ICB_CF_CKD_64_1D" (see below). A patient is included when they do NOT match Rule 1.
...
4. **ICB_CF_CKD_64_1D** — Include patients who do not match Clinical Codes with Chronic kidney disease screening where Date within the last 3 years.
...
| ICB_CF_CKD_64_1D | `at_risk_of_ckd_who_are_not_on_ckd_reg_vs1` |  |  | SNOMED | 1 | Chronic kidney disease screening | b8a16fba |
