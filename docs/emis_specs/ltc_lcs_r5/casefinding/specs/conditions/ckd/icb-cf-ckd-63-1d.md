...
Report title: [ICB_CF_CKD_63_1D] With most recent UACR>70 and not on CKD Register/CKD diagnosi
Folder: 1) Casefinding R2 > [CF-CKD] CKD Case finding
Source: NCL LTC LCS R5.0 updated: 27112025

## What this search does

Start with the patients found by "ICB_CF_CKD_63_1D_woEX" (see below). A patient is included when they do NOT match Rule 1.
...
- **Criterion A — Clinical Codes** (clinical events)
  - Code in: `with_most_recent_uacr70_and_not_on_ckd_regckd_diagnosi_vs1` (1 code)
...
| ICB_CF_CKD_63_1D | `with_most_recent_uacr70_and_not_on_ckd_regckd_diagnosi_vs1` |  | 1 | SNOMED | 1 | Chronic kidney disease screening | b8a16fba |
