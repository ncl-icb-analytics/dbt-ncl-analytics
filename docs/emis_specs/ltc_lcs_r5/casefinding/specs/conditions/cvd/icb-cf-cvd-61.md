...
Report title: [ICB_CF_CVD_61] People at high risk CVD - Eligible pop with QRISK>=20
Folder: 1) Casefinding R2 > [CF-CVD] High risk CVD
Source: NCL LTC LCS R5.0 updated: 27112025

## What this search does

Start with the patients found by "ICB_CF_CVD_61_woEX" (see below). A patient is included when they do NOT match Rule 1.
...
- **Criterion A — Clinical Codes** (clinical events)
  - Code in: `people_at_high_risk_cvd_eligible_pop_with_qrisk20_vs1` (1 code)
...
| ICB_CF_CVD_61 | `people_at_high_risk_cvd_eligible_pop_with_qrisk20_vs1` |  | 1 | SNOMED | 1 | Cardiovascular disease high risk review declined | c0e1227a |
