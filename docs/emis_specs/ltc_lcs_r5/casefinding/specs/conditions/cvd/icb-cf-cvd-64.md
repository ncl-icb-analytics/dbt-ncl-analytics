...
Report title: [ICB_CF_CVD_64] with a QRisk2 ≥10% and not on a statin
Folder: 1) Casefinding R2 > [CF-CVD] High risk CVD
Source: NCL LTC LCS R5.0 updated: 27112025

## What this search does

Start with the patients found by "ICB_CF_CVD_64_woEX" (see below). A patient is included when they do NOT match Rule 1.
...
- **Criterion A — Clinical Codes** (clinical events)
  - Code in: `with_a_qrisk2_10_and_not_on_a_statin_vs1` (1 code)
...
| ICB_CF_CVD_64 | `with_a_qrisk2_10_and_not_on_a_statin_vs1` |  | 1 | SNOMED | 1 | Cardiovascular disease high risk review declined | c0e1227a |
