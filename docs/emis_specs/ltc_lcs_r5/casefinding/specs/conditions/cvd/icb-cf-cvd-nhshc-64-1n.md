...
Report title: [ICB_CF_CVD_NHSHC_64_1N] Requires NHS Health check
Folder: 1) Casefinding R2 > [CF-CVD] High risk CVD
Source: NCL LTC LCS R5.0 updated: 27112025

## What this search does

Start with the patients found by "ICB_CF_CVD_NHSHC_64_1D" (see below). A patient is included when they do NOT match Rule 1.
...
5. **ICB_CF_CVD_NHSHC_64_1D** — Include patients who match Patients included in search NHSHC_ELIGIBLE.
...
| ICB_CF_CVD_NHSHC_64_1N | `requires_nhs_health_check_vs1` |  | 1 | SNOMED | 1 | NHS Health Check completed | 69caa6b6 |
