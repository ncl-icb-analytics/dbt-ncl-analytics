...
Report title: [ICB_CF_CVD_65] With QRisk2>=10 amd not on a High intensity statin
Folder: 1) Casefinding R2 > [CF-CVD] High risk CVD
Source: NCL LTC LCS R5.0 updated: 27112025

## What this search does

Start with the patients found by "ICB_CF_CVD_65_woEX" (see below). A patient is included when they do NOT match Rule 1.
...
- **Criterion A — Clinical Codes** (clinical events)
  - Code in: `with_qrisk210_amd_not_on_a_high_intensity_statin_vs1` (1 code)
...
| ICB_CF_CVD_65 | `with_qrisk210_amd_not_on_a_high_intensity_statin_vs1` |  | 1 | SNOMED | 1 | Cardiovascular disease high risk review declined | c0e1227a |
