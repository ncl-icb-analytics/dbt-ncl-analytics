...
Report title: [ICB_CF_CVD_62] People at high risk CVD - Eligible population with QRISK 15-20
Folder: 1) Casefinding R2 > [CF-CVD] High risk CVD
Source: NCL LTC LCS R5.0 updated: 27112025

## What this search does

Start with the patients found by "ICB_CF_CVD_62_woEX" (see below). A patient is included when they do NOT match Rule 1.
...
- **Criterion A — Clinical Codes** (clinical events)
  - Code in: `people_at_high_risk_cvd_eligible_population_with_qrisk_15_20_vs1` (1 code)
...
| ICB_CF_CVD_62 | `people_at_high_risk_cvd_eligible_population_with_qrisk_15_20_vs1` |  | 1 | SNOMED | 1 | Cardiovascular disease high risk review declined | c0e1227a |
