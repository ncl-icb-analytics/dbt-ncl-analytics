...
Report title: [ICB_CF_CVD_NHSHC_SMOK_64_2] Requires Smoking Status to be recorded
Folder: 1) Casefinding R2 > [CF-CVD] High risk CVD
Source: NCL LTC LCS R5.0 updated: 27112025

## What this search does

Start with the patients found by "ICB_CF_CVD_NHSHC_64_2D" (see below). A patient is included when they do NOT match Rule 1.
...
5. **ICB_CF_CVD_NHSHC_64_2D** — Include patients who do not match Patients included in search NHSHC_ELIGIBLE.
...
| ICB_CF_CVD_NHSHC_SMOK_64_2 | `requires_smoking_status_to_be_recorded_vs1` | SMOK_COD | 1 | SNOMED | 1 | Refset: 999005651000230102 | a90af260 |
| ICB_CF_CVD_NHSHC_SMOK_64_2 | `requires_smoking_status_to_be_recorded_vs2` | NSMOK_COD | 1 | SNOMED | 1 | Refset: 999006051000230100 | 281756fe |
| ICB_CF_CVD_NHSHC_SMOK_64_2 | `requires_smoking_status_to_be_recorded_vs3` |  | 1 | SNOMED | 1 | UK NHS primary care data extraction - General practice data extraction - ex t... | 5cf86f55 |
