# ICB_CF_CVD_NHSHC_65_1D

Report title: [ICB_CF_CVD_NHSHC_65_1D] Eligible for NHS Health check
...
Start with the patients found by "ICB_CF_CVD_65" (see below). A patient is included when they match Rule 1.
