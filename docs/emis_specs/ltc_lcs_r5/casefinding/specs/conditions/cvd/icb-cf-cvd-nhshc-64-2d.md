# ICB_CF_CVD_NHSHC_64_2D

Report title: [ICB_CF_CVD_NHSHC_64_2D] Not Eligible for NHS health check
...
Start with the patients found by "ICB_CF_CVD_64" (see below). A patient is included when they do NOT match Rule 1.
