# ICB_CF_AF_NHSHC_62_2D

Report title: [ICB_CF_AF_NHSHC_62_2D] Not eligible for NHS Health check
Folder: 1) Casefinding R2 > [CF-AF] AF Case finding
Source: NCL LTC LCS R5.0 updated: 27112025
Description: If not eligible for NHS Health Check, invite for pulse check and BP.

## What this search does

Start with the patients found by "ICB_CF_AF_62" (see below). A patient is included when they do NOT match Rule 1.
