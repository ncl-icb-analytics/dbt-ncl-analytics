...
Report title: [ICB_CF_AF_PULSE_62] Requires Pulse check
Folder: 1) Casefinding R2 > [CF-AF] AF Case finding
Source: NCL LTC LCS R5.0 updated: 27112025

## What this search does

Start with the patients found by "ICB_CF_AF_NHSHC_62_2D" (see below). A patient is included when they do NOT match Rule 1.
...
- **Criterion A — Clinical Codes** (clinical events)
  - Code in: `requires_pulse_check_vs1` (2 codes)
...
| ICB_CF_AF_PULSE_62 | `requires_pulse_check_vs1` |  | 1 | SNOMED | 2 | O/E - pulse rhythm, O/E - pulse rate | d8324fa3 |
