...
Report title: [ICB_CF_AF_PULIRR_62] Pulse Irregular - Requires review of AF coding
Folder: 1) Casefinding R2 > [CF-AF] AF Case finding
Source: NCL LTC LCS R5.0 updated: 27112025
Description: If pulse irregular, confirm if AF with 12 lead ECG or AliveCor and investigate further/ treat/ refer as per guidance

## What this search does

Start with the patients found by "ICB_CF_AF_PULSE_62" (see below). A patient is included when they match Rule 1.
...
4. **ICB_CF_AF_62** — Include patients who do not match Clinical Codes with Atrial fibrillation excluded, Atrial fibrillation confirmed where Date within the last 3 years.
5. **ICB_CF_AF_NHSHC_62_2D** — Include patients who do not match Patients included in search NHSHC_ELIGIBLE.
   - Combines: **NHSHC_ELIGIBLE**
6. **ICB_CF_AF_PULSE_62** — Include patients who do not match Clinical Codes with O/E - pulse rhythm, O/E - pulse rate where Date within the last 3 years.
7. **This search** — applies the rules below.
...
- **Criterion A — Clinical Codes** (clinical events)
  - Code in: `pulse_irregular_requires_review_of_af_coding_vs1` (2 codes)
...
| ICB_CF_AF_62 | `af_case_finding_eligible_population_over_65s_missing_pulse_vs1` |  |  | SNOMED | 2 | Atrial fibrillation excluded, Atrial fibrillation confirmed | ea9dcb07 |
| ICB_CF_AF_PULSE_62 | `requires_pulse_check_vs1` |  |  | SNOMED | 2 | O/E - pulse rhythm, O/E - pulse rate | d8324fa3 |
| ICB_CF_AF_PULIRR_62 | `pulse_irregular_requires_review_of_af_coding_vs1` |  | 1 | SNOMED | 2 | O/E - irregular pulse, Pulse irregular | cb08c7f8 |
