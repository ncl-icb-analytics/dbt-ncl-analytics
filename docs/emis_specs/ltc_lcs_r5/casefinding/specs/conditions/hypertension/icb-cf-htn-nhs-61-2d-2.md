...
Report title: [ICB_CF_HTN_NHS_61_2D] Requires BP check
Folder: 1) Casefinding R2 > [CF-HTN] Raised BP(Possible HTN) - UCLP Criteria
Source: NCL LTC LCS R5.0 updated: 27112025

## What this search does

Start with the patients found by "ICB_CF_HTN_NHS_61_2D" (see below). A patient is included when they do NOT match Rule 1.
...
5. **ICB_CF_HTN_NHS_61_2D** — Include patients who do not match Patients included in search NHSHC_ELIGIBLE.
...
| ICB_CF_HTN_NHS_61_2D | `requires_bp_check_vs1` |  | 1 | SNOMED | 1 | O/E - blood pressure reading | 91cb1fb0 |
