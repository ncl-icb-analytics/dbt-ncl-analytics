# ICB_CF_HTN_NHS_61_1D

Report title: [ICB_CF_HTN_NHS_61_1D] Eligible for NHS Health check
...
Start with the patients found by "ICB_CF_HTN_61" (see below). A patient is included when they match Rule 1.
