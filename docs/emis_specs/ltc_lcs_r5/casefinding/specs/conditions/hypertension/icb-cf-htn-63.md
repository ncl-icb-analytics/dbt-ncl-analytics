...
Report title: [ICB_CF_HTN_63] UCLP Priority Group 2b
Folder: 1) Casefinding R2 > [CF-HTN] Raised BP(Possible HTN) - UCLP Criteria
Source: NCL LTC LCS R5.0 updated: 27112025

## What this search does

Start with the patients found by "ICB_CF_HTN_63_woEX" (see below). A patient is included when they do NOT match Rule 1.
...
- **Criterion A — Clinical Codes** (clinical events)
  - Code in: `uclp_priority_group_2b_vs1` (1 code)
...
| ICB_CF_HTN_63 | `uclp_priority_group_2b_vs1` |  | 1 | SNOMED | 1 | Hypertension screening | a4b6291a |
