...
Report title: [ICB_CF_DM_NHS_66_1D] Eligible for NHS Health check
...
Start with the patients found by "ICB_CF_DM_66" (see below). A patient is included when they match Rule 1.
