...
Report title: [ICB_CF_DM_NHS_BMI_63_2] Requires BMI check
...
- **Criterion A — Clinical Codes** (clinical events)
  - Code in: `requires_bmi_check_vs1` (1 code)
...
| ICB_CF_DM_NHS_BMI_63_2 | `requires_bmi_check_vs1` |  | 1 | SNOMED | 1 | Body mass index | 30a0e00c |
