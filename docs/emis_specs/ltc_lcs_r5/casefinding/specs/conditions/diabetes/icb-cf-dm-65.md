...
Report title: [ICB_CF_DM_65] With latest BMI ≥30/27.5(BAME populationand no HbA1c in L2/Y
Folder: 1) Casefinding R2 > [CF-DM] High risk Diabetes
Source: NCL LTC LCS R5.0 updated: 27112025

## What this search does

Start with the patients found by "ICB_CF_DM_65_woEX" (see below). A patient is included when they do NOT match Rule 1.
...
- **Criterion A — Clinical Codes** (clinical events)
  - Code in: `with_latest_bmi_30275bame_populationand_no_hba1c_in_l2y_vs1` (1 code)
...
| ICB_CF_DM_65 | `with_latest_bmi_30275bame_populationand_no_hba1c_in_l2y_vs1` |  | 1 | SNOMED | 1 | High risk of diabetes mellitus annual review declined | 29adf77b |
