...
Report title: [ICB_CF_DM_NHS_66_2D] Not Eligible for NHS health check
...
Start with the patients found by "ICB_CF_DM_66" (see below). A patient is included when they do NOT match Rule 1.
