...
Report title: [ICB_CF_DM_63] Latest HbA1c 46-47 and no HbA1c in the last year
Folder: 1) Casefinding R2 > [CF-DM] High risk Diabetes
Source: NCL LTC LCS R5.0 updated: 27112025

## What this search does

Start with the patients found by "ICB_CF_DM_63_woEX" (see below). A patient is included when they do NOT match Rule 1.
...
- **Criterion A — Clinical Codes** (clinical events)
  - Code in: `latest_hba1c_46_47_and_no_hba1c_in_the_last_year_vs1` (1 code)
...
| ICB_CF_DM_63 | `latest_hba1c_46_47_and_no_hba1c_in_the_last_year_vs1` |  | 1 | SNOMED | 1 | High risk of diabetes mellitus annual review declined | 29adf77b |
