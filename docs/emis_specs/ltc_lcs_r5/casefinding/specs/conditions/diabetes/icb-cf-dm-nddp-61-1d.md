...
Report title: [ICB_CF_DM_NDDP_61_1D] NDPP Eligible Population
...
Start with the patients found by "ICB_CF_DM_61" (see below). Patients must match Rules 1 and 3 to stay in. Patients matching Rules 2 and 4-6 are excluded. A patient is included when they do NOT match Rule 7. Rules run in order; each patient stops at the first rule that includes or excludes them.
...
| ICB_CF_DM_NDDP_61_1D | `ndpp_eligible_population_vs1` | PREG_COD | 2 | SNOMED | 82 | Pregnant - on abdom. palpation, Pregnancy insufficiently advanced for reliabl... | b82805bb |
| ICB_CF_DM_NDDP_61_1D | `ndpp_eligible_population_vs2` |  |  | Internal | 1 | Active Problem | 559aead0 |
| ICB_CF_DM_NDDP_61_1D | `ndpp_eligible_population_vs3` |  | 3 | SNOMED | 1 | Haemoglobin A1c level - International Federation of Clinical Chemistry and La... | 50ab8202 |
| ICB_CF_DM_NDDP_61_1D | `ndpp_eligible_population_vs4` |  | 3 | SNOMED | 3 | Plasma fasting glucose level, Serum fasting glucose level, Fasting blood gluc... | b0cde2cf |
| ICB_CF_DM_NDDP_61_1D | `ndpp_eligible_population_vs5` |  | 3 | SNOMED | 4 | Gestational diabetes mellitus, Gestational diabetes mellitus uncontrolled, Ge... | 2e762dad |
| ICB_CF_DM_NDDP_61_1D | `ndpp_eligible_population_vs6` |  | 4 | SNOMED | 3 | NHS Diabetes Prevention Programme invitation, Referral to NHS Diabetes Preven... | f10d89c3 |
| ICB_CF_DM_NDDP_61_1D | `ndpp_eligible_population_vs7` |  | 5 | SNOMED | 2 | Unsuitable for NHS Diabetes Prevention Programme, NHS Diabetes Prevention Pro... | eac3168f |
