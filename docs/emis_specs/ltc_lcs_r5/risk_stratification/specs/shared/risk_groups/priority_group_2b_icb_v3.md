<!-- Extracted from 'NCL LTC LCS R5 updated 27112025.xml' (sha256 e4984ab973047c074d5cecc3264b29e424751894cf342b1ff371b39c39f5e8f8)
     report id: 0xhgrgs0-uzae-gv-0r4n-1r7xi5t1j57m
...
Start with the patients found by "LTC LCS: Hypertension Register*" (see below). Patients must match Rules 3-5 to stay in. Patients matching Rules 1-2 and 6 are excluded. A patient is included when they do NOT match Rule 7. Rules run in order; each patient stops at the first rule that includes or excludes them.
...
- **Criterion A — Clinical Codes** (clinical events)
  *"Blood Pressure reading excluding home done in last 12 months"*
  - Code in: `priority_group_2b_icb_v3_vs1` (1 code — cluster CLINBP_COD), or `priority_group_2b_icb_v3_vs2` (5 codes — cluster HOMEAMBBP_COD)
...
- **Criterion A — Clinical Codes** (clinical events)
  - Code in: `priority_group_2b_icb_v3_vs3` (78 codes)
...
- **Criterion A — Clinical Codes** (clinical events)
  *"CHD Register"*
  - Code in: `priority_group_2b_icb_v3_vs4` (444 codes — cluster CHD_COD)
  - Where episode type is not Review or Ended
- **Criterion B — Clinical Codes** (clinical events)
  *"Stroke / TIA Register"*
  - Code in: `priority_group_2b_icb_v3_vs5` (271 codes — cluster STRK_COD), or `priority_group_2b_icb_v3_vs6` (38 codes — cluster TIA_COD)
  - Where episode type is not Review or Ended
- **Criterion C — Clinical Codes** (clinical events)
  *"PAD Register"*
  - Code in: `priority_group_2b_icb_v3_vs7` (32 codes — cluster PAD_COD)
  - Where episode type is not Review or Ended
- **Criterion D — Clinical Codes** (clinical events)
  *"Latest Occurrence of CKD Stage 3 to 5"*
  - Code in: `priority_group_2b_icb_v3_vs8` (106 codes — cluster CKD_COD)
- **Criterion E — Clinical Codes** (clinical events)
  - Code in: `priority_group_2b_icb_v3_vs9` (1 code)
...
- **Criterion F — Clinical Codes** (clinical events)
  *"Earliest Occurrence of Diabetes"*
  - Code in: `priority_group_2b_icb_v3_vs10` (527 codes — cluster DM_COD)
- **Criterion G — Clinical Codes** (clinical events)
  - Code in: `priority_group_2b_icb_v3_vs11` (5 codes)
  ...
  *"Blood Pressure reading excluding home done in last 12 months"*
  ...
  - **Linked record A.1** — join: same date as record A
    *"Latest Systolic HOMEBP/BPEXHOME"*
    - Code in: `priority_group_2b_icb_v3_vs12` (49 codes — cluster Systolic Blood Pressure)
    - Where numeric value > 0
    - Keep only the latest 100 matching records
    - **Linked record A.1.1** — join: same date as record A.1
      *"Latest Diastolic HOMEBP/BPEXHOME"*
      - Code in: `priority_group_2b_icb_v3_vs13` (45 codes — cluster Diastolic Blood Pressure), or `priority_group_2b_icb_v3_vs1` (1 code — cluster CLINBP_COD)
      - Where numeric value > 0
      - Keep only the latest matching record, and require its code to be in: CLINBP_COD
- **Criterion B — Clinical Codes** (clinical events)
  *"Blood Pressure reading excluding home done in last 12 months"*
  - Code in: `priority_group_2b_icb_v3_vs1` (1 code — cluster CLINBP_COD)
  ...
  - **Linked record B.1** — join: same date as record B
    *"Latest Systolic BPEXHOME equal or less than 140"*
    - Code in: `priority_group_2b_icb_v3_vs14` (36 codes — cluster Systolic Blood Pressure)
    - Where numeric value > 0
    - Keep only the latest 100 matching records
    - **Linked record B.1.1** — join: same date as record B.1
      *"Latest Diastolic BPEXHOME equal or less than 90"*
      - Code in: `priority_group_2b_icb_v3_vs15` (32 codes — cluster Diastolic Blood Pressure)
      - Where numeric value > 0
  ...
  *"Blood Pressure reading done at home in last 12 months"*
  ...
  - Requires this group — **ALL (AND)** of the following:
    - **A.2 — Clinical Codes** (clinical events)
      *"Blood Pressure reading done at Home in last 12 months"*
      - Code in: `priority_group_2b_icb_v3_vs2` (5 codes — cluster HOMEAMBBP_COD)
      - Keep only the latest 100 matching records
      - **Linked record A.2.1** — join: same date as record A.2
        *"Latest Systolic HOMEBP equal or less than 135"*
        - Code in: `priority_group_2b_icb_v3_vs14` (13 codes — cluster Systolic Blood Pressure)
        - Where numeric value > 0
        - Keep only the latest 100 matching records
        - **Linked record A.2.1.1** — join: same date as record A.2.1
          *"Latest Diastolic HOMEBP equal or less than 85"*
          - Code in: `priority_group_2b_icb_v3_vs16` (13 codes — cluster Diastolic Blood Pressure)
          - Where numeric value > 0
          - Keep only the latest matching record
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Priority Group 2b (ICB) v3 | `priority_group_2b_icb_v3_vs1` | CLINBP_COD | 3, 6, 7 | SNOMED | 1 | Refset: 999036281000230108 | f806e309 |
| Priority Group 2b (ICB) v3 | `priority_group_2b_icb_v3_vs10` | DM_COD | 5 | SNOMED | 527 | Hyperosmolar hyperglycaemic coma due to diabetes mellitus without ketoacidosi... | ea63b842 |
| Priority Group 2b (ICB) v3 | `priority_group_2b_icb_v3_vs11` |  | 5 | SNOMED | 5 | Body mass index, BMI - Body mass index, Weight: body mass +1 more | 435b40ad |
| Priority Group 2b (ICB) v3 | `priority_group_2b_icb_v3_vs12` | Systolic Blood Pressure | 6 | SNOMED | 49 | Minimum systolic blood pressure, Systemic blood pressure, SBP - Systemic bloo... | dbe8bf65 |
| Priority Group 2b (ICB) v3 | `priority_group_2b_icb_v3_vs13` | Diastolic Blood Pressure | 6 | SNOMED | 45 | Minimum diastolic blood pressure, Minimum day interval diastolic blood pressu... | 94656e9b |
| Priority Group 2b (ICB) v3 | `priority_group_2b_icb_v3_vs14` | Systolic Blood Pressure | 6, 7 | SNOMED | 36 | Systemic blood pressure, SBP - Systemic blood pressure, Lying systolic blood ... | 5b356e22 |
| Priority Group 2b (ICB) v3 | `priority_group_2b_icb_v3_vs15` | Diastolic Blood Pressure | 6, 7 | SNOMED | 32 | Increased diastolic arterial pressure, High diastolic arterial pressure, Incr... | 2c57ad8d |
| Priority Group 2b (ICB) v3 | `priority_group_2b_icb_v3_vs16` | Diastolic Blood Pressure | 7 | SNOMED | 13 | Minimum diastolic blood pressure, Average 24 hour diastolic blood pressure, A... | 5f525c4f |
| Priority Group 2b (ICB) v3 | `priority_group_2b_icb_v3_vs2` | HOMEAMBBP_COD | 3, 6, 7 | SNOMED | 5 | 24 hour blood pressure, Average blood pressure, 24 hr blood pressure monitori... | 0daae157 |
| Priority Group 2b (ICB) v3 | `priority_group_2b_icb_v3_vs3` |  | 4 | SNOMED | 78 | Black African, Black Caribbean, Black Black - other +73 more | 88a4167f |
| Priority Group 2b (ICB) v3 | `priority_group_2b_icb_v3_vs4` | CHD_COD | 5 | SNOMED | 444 | Mural thrombus of right ventricle following acute myocardial infarction, Post... | e4c73e0d |
| Priority Group 2b (ICB) v3 | `priority_group_2b_icb_v3_vs5` | STRK_COD | 5 | SNOMED | 271 | Thrombosis of left middle cerebral artery, Left middle cerebral artery thromb... | bb3a48ed |
| Priority Group 2b (ICB) v3 | `priority_group_2b_icb_v3_vs6` | TIA_COD | 5 | SNOMED | 38 | Transient cerebral ischemia, Anterior circulation transient ischaemic attack,... | 8b1f1274 |
| Priority Group 2b (ICB) v3 | `priority_group_2b_icb_v3_vs7` | PAD_COD | 5 | SNOMED | 32 | Claudication, Charcot  s syndrome, IC - Intermittent claudication +27 more | e5d7772c |
| Priority Group 2b (ICB) v3 | `priority_group_2b_icb_v3_vs8` | CKD_COD | 5 | SNOMED | 106 | Anaemia co-occurrent and due to chronic kidney disease stage 3, Anemia co-occ... | 68fffd80 |
| Priority Group 2b (ICB) v3 | `priority_group_2b_icb_v3_vs9` |  | 5 | SNOMED | 1 | GFR (glomerular filtration rate) calculated by abbreviated Modification of Di... | 20855d05 |
