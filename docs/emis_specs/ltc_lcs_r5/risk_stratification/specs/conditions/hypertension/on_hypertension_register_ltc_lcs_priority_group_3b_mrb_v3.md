<!-- Extracted from 'NCL LTC LCS R5 updated 27112025.xml' (sha256 e4984ab973047c074d5cecc3264b29e424751894cf342b1ff371b39c39f5e8f8)
     report id: 10rksai1-oc0h-8c-1xs2-1jwaql6173d9
...
Start with the patients found by "LTC LCS: Hypertension Register*" (see below). Patients must match Rule 1 to stay in. Patients matching Rules 2-4 and 6 are excluded. A patient is included unless they match every one of Rules 5 and 7 — failing any one of them includes the patient. Rules run in order; each patient stops at the first rule that includes or excludes them.
...
- **Criterion A — Clinical Codes** (clinical events)
  *"Blood Pressure reading excluding home done in last 12 months"*
  - Code in: `on_htn_reg_priority_group_3b_mrb_v3_vs1` (1 code — cluster CLINBP_COD), or `on_htn_reg_priority_group_3b_mrb_v3_vs2` (5 codes — cluster HOMEAMBBP_COD)
  ...
  *"Blood Pressure reading excluding home done in last 12 months"*
  ...
  - **Linked record A.1** — join: same date as record A
    *"Latest Systolic HOMEBP/BPEXHOME"*
    - Code in: `on_htn_reg_priority_group_3b_mrb_v3_vs3` (49 codes — cluster Systolic Blood Pressure)
    - Where numeric value > 0
    - Keep only the latest 100 matching records
    - **Linked record A.1.1** — join: same date as record A.1
      *"Latest Diastolic HOMEBP/BPEXHOME"*
      - Code in: `on_htn_reg_priority_group_3b_mrb_v3_vs4` (45 codes — cluster Diastolic Blood Pressure), or `on_htn_reg_priority_group_3b_mrb_v3_vs1` (1 code — cluster CLINBP_COD)
      - Where numeric value > 0
      - Keep only the latest matching record, and require its code to be in: CLINBP_COD
- **Criterion B — Clinical Codes** (clinical events)
  *"Blood Pressure reading excluding home done in last 12 months"*
  - Code in: `on_htn_reg_priority_group_3b_mrb_v3_vs1` (1 code — cluster CLINBP_COD)
  ...
  - **Linked record B.1** — join: same date as record B
    *"Latest Systolic BPEXHOME equal or less than 140"*
    - Code in: `on_htn_reg_priority_group_3b_mrb_v3_vs5` (36 codes — cluster Systolic Blood Pressure)
    - Where numeric value > 0
    - Keep only the latest 100 matching records
    - **Linked record B.1.1** — join: same date as record B.1
      *"Latest Diastolic BPEXHOME equal or less than 90"*
      - Code in: `on_htn_reg_priority_group_3b_mrb_v3_vs6` (32 codes — cluster Diastolic Blood Pressure)
      - Where numeric value > 0
  ...
  *"Blood Pressure reading done at home in last 12 months"*
  ...
  - Requires this group — **ALL (AND)** of the following:
    - **A.2 — Clinical Codes** (clinical events)
      *"Blood Pressure reading done at Home in last 12 months"*
      - Code in: `on_htn_reg_priority_group_3b_mrb_v3_vs2` (5 codes — cluster HOMEAMBBP_COD)
      - Keep only the latest 100 matching records
      - **Linked record A.2.1** — join: same date as record A.2
        *"Latest Systolic HOMEBP equal or less than 135"*
        - Code in: `on_htn_reg_priority_group_3b_mrb_v3_vs5` (13 codes — cluster Systolic Blood Pressure)
        - Where numeric value > 0
        - Keep only the latest 100 matching records
        - **Linked record A.2.1.1** — join: same date as record A.2.1
          *"Latest Diastolic HOMEBP equal or less than 85"*
          - Code in: `on_htn_reg_priority_group_3b_mrb_v3_vs7` (13 codes — cluster Diastolic Blood Pressure)
          - Where numeric value > 0
          - Keep only the latest matching record
...
### Rule 5 of 7 — Inclusion route (on no match)
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| On Hypertension Register- LTC LCS Priority Group 3B (MRb) v3 | `on_htn_reg_priority_group_3b_mrb_v3_vs1` | CLINBP_COD | 1, 3, 4, 6, 7 | SNOMED | 1 | Refset: 999036281000230108 | f806e309 |
| On Hypertension Register- LTC LCS Priority Group 3B (MRb) v3 | `on_htn_reg_priority_group_3b_mrb_v3_vs2` | HOMEAMBBP_COD | 1, 3, 4, 6, 7 | SNOMED | 5 | 24 hour blood pressure, Average blood pressure, 24 hr blood pressure monitori... | 0daae157 |
| On Hypertension Register- LTC LCS Priority Group 3B (MRb) v3 | `on_htn_reg_priority_group_3b_mrb_v3_vs3` | Systolic Blood Pressure | 3, 6 | SNOMED | 49 | Minimum systolic blood pressure, Systemic blood pressure, SBP - Systemic bloo... | dbe8bf65 |
| On Hypertension Register- LTC LCS Priority Group 3B (MRb) v3 | `on_htn_reg_priority_group_3b_mrb_v3_vs4` | Diastolic Blood Pressure | 3, 6 | SNOMED | 45 | Minimum diastolic blood pressure, Minimum day interval diastolic blood pressu... | 94656e9b |
| On Hypertension Register- LTC LCS Priority Group 3B (MRb) v3 | `on_htn_reg_priority_group_3b_mrb_v3_vs5` | Systolic Blood Pressure | 3, 4, 6, 7 | SNOMED | 36 | Systemic blood pressure, SBP - Systemic blood pressure, Lying systolic blood ... | 5b356e22 |
| On Hypertension Register- LTC LCS Priority Group 3B (MRb) v3 | `on_htn_reg_priority_group_3b_mrb_v3_vs6` | Diastolic Blood Pressure | 3, 4, 6, 7 | SNOMED | 32 | Increased diastolic arterial pressure, High diastolic arterial pressure, Incr... | 2c57ad8d |
| On Hypertension Register- LTC LCS Priority Group 3B (MRb) v3 | `on_htn_reg_priority_group_3b_mrb_v3_vs7` | Diastolic Blood Pressure | 4, 7 | SNOMED | 13 | Minimum diastolic blood pressure, Average 24 hour diastolic blood pressure, A... | 5f525c4f |
