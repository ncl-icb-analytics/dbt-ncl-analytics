...
Start with the patients found by "LTC LCS: Asthma Adult Register*" (see below). Patients matching Rule 1 are excluded. A patient is included when they match any one of Rules 2-3. Rules run in order; each patient stops at the first rule that includes or excludes them.
...
| On Asthma(Adult) Register- LTC LCS Priority Group 4 (LR)* | `on_asthma_adult_reg_pg4_lr_vs1` |  | 2 | SCT Const | 6 | Beclometasone Dipropionate, Budesonide, Ciclesonide +3 more | a2d6b25c |
| On Asthma(Adult) Register- LTC LCS Priority Group 4 (LR)* | `on_asthma_adult_reg_pg4_lr_vs2` |  | 3 | SCT Const | 3 | Salbutamol, Salbutamol Cr, Terbutaline Sulfate | 5c851fb5 |
