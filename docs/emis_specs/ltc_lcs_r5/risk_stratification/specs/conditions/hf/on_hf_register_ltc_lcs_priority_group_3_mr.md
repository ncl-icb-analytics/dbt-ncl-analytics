...
| 8 | Continue to Rule 9 | **Included** | Inclusion route (on no match) |
| 9 | Excluded | **Included** | Final — exclude if matched |

## Rule details

### Rule 1 of 9 — Exclusion
...
### Rule 6 of 9 — Inclusion route (on no match)
...
### Rule 7 of 9 — Inclusion route (on no match)
...
### Rule 8 of 9 — Inclusion route (on no match)
...
### Rule 9 of 9 — Final — exclude if matched
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| On HF Register- LTC LCS Priority Group 3 (MR)* | `on_hf_reg_pg3_mr_vs1` | HF_COD | 2 | SNOMED | 1 | Refset: 999013691000230108 | 94f38705 |
| On HF Register- LTC LCS Priority Group 3 (MR)* | `on_hf_reg_pg3_mr_vs10` |  | 7 | SNOMED | 5 | Adverse reaction to Spironolactone, Adverse reaction to Eplerenone, Adverse r... | 3338e94b |
| On HF Register- LTC LCS Priority Group 3 (MR)* | `on_hf_reg_pg3_mr_vs11` | LBB_COD | 8 | SNOMED | 54 | Bisoprolol 5mg / Aspirin 75mg capsules, Bisoprolol 5mg / Aspirin 100mg capsul... | 45878485 |
| On HF Register- LTC LCS Priority Group 3 (MR)* | `on_hf_reg_pg3_mr_vs12` | XLBB_COD | 8 | SNOMED | 3 | Hypersensitivity to atenolol, Atenolol hypersensitivity | af676e6c |
| On HF Register- LTC LCS Priority Group 3 (MR)* | `on_hf_reg_pg3_mr_vs13` | TXLBB_COD | 8 | SNOMED | 1 | Refset: 999008251000230108 | 46d0d2c0 |
| On HF Register- LTC LCS Priority Group 3 (MR)* | `on_hf_reg_pg3_mr_vs14` | LBBDEC_COD | 8 | SNOMED | 1 | Refset: 999013291000230105 | f6f51ae7 |
| On HF Register- LTC LCS Priority Group 3 (MR)* | `on_hf_reg_pg3_mr_vs15` |  | 9 | SCT_PREP | 352 | Acepril 12.5mg tablets (Bristol-Myers Squibb Pharmaceuticals Ltd), Acepril 25... | 5c072804 |
| On HF Register- LTC LCS Priority Group 3 (MR)* | `on_hf_reg_pg3_mr_vs16` | ACEDEC_COD | 9 | SNOMED | 1 | Refset: 999009011000230109 | 8a36ae84 |
| On HF Register- LTC LCS Priority Group 3 (MR)* | `on_hf_reg_pg3_mr_vs17` | AIIDEC_COD | 9 | SNOMED | 1 | Refset: 999008011000230100 | f2d0e917 |
| On HF Register- LTC LCS Priority Group 3 (MR)* | `on_hf_reg_pg3_mr_vs18` |  | 9 | SNOMED | 171 | Lisinopril adverse reaction, H/O: angiotensin converting enzyme inhibitor pse... | 277499b3 |
| On HF Register- LTC LCS Priority Group 3 (MR)* | `on_hf_reg_pg3_mr_vs19` | XAII_COD | 9 | SNOMED | 1 | Refset: 999004331000230101 | d4aea85d |
| On HF Register- LTC LCS Priority Group 3 (MR)* | `on_hf_reg_pg3_mr_vs2` |  | 3 | SNOMED | 4 | New York Heart Association Classification - Class I, New York Heart Associati... | 4ec0ed9b |
| On HF Register- LTC LCS Priority Group 3 (MR)* | `on_hf_reg_pg3_mr_vs20` | TXAII_COD | 9 | SNOMED | 1 | Refset: 999004491000230106 | 24284ef4 |
| On HF Register- LTC LCS Priority Group 3 (MR)* | `on_hf_reg_pg3_mr_vs3` |  | 3 | SNOMED | 1 | New York Heart Association Classification - Class II | 7cb628e4 |
| On HF Register- LTC LCS Priority Group 3 (MR)* | `on_hf_reg_pg3_mr_vs4` |  | 4 | SNOMED | 11 | O/E - oedema not present, O/E - oedema of ankles, O/E - oedema of feet +8 more | e9b19d9f |
| On HF Register- LTC LCS Priority Group 3 (MR)* | `on_hf_reg_pg3_mr_vs5` |  | 4 | SNOMED | 7 | O/E - oedema of feet, Bilateral feet oedema, O/E - oedema of ankles +4 more | 27256413 |
| On HF Register- LTC LCS Priority Group 3 (MR)* | `on_hf_reg_pg3_mr_vs6` |  | 5 | SNOMED | 1 | Left ventricular ejection fraction | 4c79b106 |
| On HF Register- LTC LCS Priority Group 3 (MR)* | `on_hf_reg_pg3_mr_vs7` |  | 6 | SCT Const | 4 | Dapagliflozin, Empagliflozin, Canagliflozin +1 more | 4ca4d3a3 |
| On HF Register- LTC LCS Priority Group 3 (MR)* | `on_hf_reg_pg3_mr_vs8` |  | 6 | SNOMED | 7 | Adverse reaction to Dapagliflozin, Adverse reaction to Empagliflozin, Adverse... | a5be9bf6 |
| On HF Register- LTC LCS Priority Group 3 (MR)* | `on_hf_reg_pg3_mr_vs9` |  | 7 | SCT Const | 3 | Spironolactone, Eplerenone, Finerenone | a4b2da82 |
