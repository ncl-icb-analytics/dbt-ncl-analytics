...
- **Criterion A — Patient Details**
  - Where age under 18 years old — `age < 18 years`
...
- **Criterion A — Clinical Codes** (clinical events)
  *"Patients Currently Diagnosed as Asthmatic"*
  - Code in: `asthma_cyp_reg_vs1` (1 code — cluster ASTRES_COD), or `asthma_cyp_reg_vs2` (1 code — cluster AST_COD)
...
- **Criterion B — Medication Issues**
  *"Patients Taking Asthma Treatment in last 12 months"*
  - Code in: `asthma_cyp_reg_vs3` (521 codes — cluster ASTTRT_COD)
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| LTC LCS: Asthma CYP Register* | `asthma_cyp_reg_vs1` | ASTRES_COD | 2 | SNOMED | 1 | Refset: 999010051000230100 | 0cecb4fb |
| LTC LCS: Asthma CYP Register* | `asthma_cyp_reg_vs2` | AST_COD | 2 | SNOMED | 1 | Refset: 999012891000230104 | b6f202b4 |
| LTC LCS: Asthma CYP Register* | `asthma_cyp_reg_vs3` | ASTTRT_COD | 2 | SNOMED | 521 | Proxor 100micrograms/dose / 6micrograms/dose inhaler (Genus Pharmaceuticals L... | d78c07e6 |
