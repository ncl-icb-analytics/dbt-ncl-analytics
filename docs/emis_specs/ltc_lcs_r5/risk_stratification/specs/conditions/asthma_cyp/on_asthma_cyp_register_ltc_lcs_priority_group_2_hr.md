...
| On Asthma(CYP) Register- LTC LCS Priority Group 2 (HR)* | `on_asthma_cyp_reg_pg2_hr_vs1` |  | 1 | SNOMED | 4 | Child on protection register, Child removed from protection register, Child n... | 6528bece |
| On Asthma(CYP) Register- LTC LCS Priority Group 2 (HR)* | `on_asthma_cyp_reg_pg2_hr_vs10` |  | 7 | SCT Const | 1 | Bambuterol Hydrochloride | 42efbe32 |
| On Asthma(CYP) Register- LTC LCS Priority Group 2 (HR)* | `on_asthma_cyp_reg_pg2_hr_vs11` |  | 7 | SCT_PREP | 28 | Atimos Modulite 12micrograms/dose inhaler (Chiesi Ltd), Foradil 12microgram i... | f9bf039c |
| On Asthma(CYP) Register- LTC LCS Priority Group 2 (HR)* | `on_asthma_cyp_reg_pg2_hr_vs12` |  | 8 | SCT Const | 6 | Beclometasone Dipropionate, Budesonide, Ciclesonide +3 more | a2d6b25c |
| On Asthma(CYP) Register- LTC LCS Priority Group 2 (HR)* | `on_asthma_cyp_reg_pg2_hr_vs2` |  | 1 | SNOMED | 1 | Child on protection register | d9a584fb |
| On Asthma(CYP) Register- LTC LCS Priority Group 2 (HR)* | `on_asthma_cyp_reg_pg2_hr_vs3` |  | 1 | SNOMED | 2 | Child in need, Child no longer in need | 8332ea34 |
| On Asthma(CYP) Register- LTC LCS Priority Group 2 (HR)* | `on_asthma_cyp_reg_pg2_hr_vs4` |  | 1 | SNOMED | 1 | Child in need | 17e62b70 |
| On Asthma(CYP) Register- LTC LCS Priority Group 2 (HR)* | `on_asthma_cyp_reg_pg2_hr_vs5` |  | 2 | SNOMED | 3 | Emergency hospital admission for asthma, Emergency asthma admission since las... | 7a5550bd |
| On Asthma(CYP) Register- LTC LCS Priority Group 2 (HR)* | `on_asthma_cyp_reg_pg2_hr_vs6` |  | 3 | SNOMED | 1 | Number of asthma exacerbations in past year | 0a99b44e |
| On Asthma(CYP) Register- LTC LCS Priority Group 2 (HR)* | `on_asthma_cyp_reg_pg2_hr_vs7` |  | 4 | SCT Const | 3 | Prednisolone, Prednisolone Sodium Phosphate, Prednisolone Steaglate | 153a3cb0 |
| On Asthma(CYP) Register- LTC LCS Priority Group 2 (HR)* | `on_asthma_cyp_reg_pg2_hr_vs8` |  | 5 | SCT Const | 5 | Theophylline, Theophylline Hydrate, Theophylline S/R +2 more | 08d2e32b |
| On Asthma(CYP) Register- LTC LCS Priority Group 2 (HR)* | `on_asthma_cyp_reg_pg2_hr_vs9` |  | 6, 8 | SCT Const | 3 | Salbutamol, Salbutamol Cr, Terbutaline Sulfate | 5c851fb5 |
