...
Start with the patients found by "LTC LCS: NAFLD Register*- EXTRA" (see below). Patients must match Rule 1 to stay in. A patient is included when they match Rule 2.
...
| C&T completed + Letter sent fy | `ct_completed_letter_sent_fy_vs1` |  | SNOMED | 1 | Chronic disease initial assessment | 2c55e088 |
| C&T completed + Letter sent fy | `ct_completed_letter_sent_fy_vs2` |  | SNOMED | 1 | Long term condition summary sent to patient | 3dad0ac0 |
