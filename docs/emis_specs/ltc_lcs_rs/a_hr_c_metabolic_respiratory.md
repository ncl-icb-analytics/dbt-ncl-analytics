...
Start with the patients found by "GROUP1- HRC" (see below). Patients must match Rule 1 to stay in. A patient is included when they match any one of Rules 2-3.
...
- **Medication Issues**
  ...
  - Where drug code in `a_hrc_metabolic_respiratory_vs4` (477 codes — cluster ASTTRT_COD)
