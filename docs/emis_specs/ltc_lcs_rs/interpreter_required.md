...
Start with the patients found by "GROUP3- MR" (see below). A patient is included when they match any one of Rules 1-2.
...
| --- | --- | --- | --- | --- | --- | --- |
| Interpreter Required | `interpreter_required_vs1` |  | SNOMED | 2 | Interpreter not needed, Interpreter needed | 32adafca |
| Interpreter Required | `interpreter_required_vs2` |  | SNOMED | 1 | Interpreter needed | 40c5d030 |
| Interpreter Required | `interpreter_required_vs3` |  | SNOMED | 1 | British Sign Language interpreter needed | 8acbbf70 |
