...
| On Asthma(CYP) Register- LTC LCS Priority Group 2 (HR)* V2 Oct 2025 | `on_asthma_cyp_reg_pg2_hr_v2_oct_2025_vs1` |  | SNOMED | 4 | Child on protection register, Child removed from protection register, Child n... | 6528bece |
| On Asthma(CYP) Register- LTC LCS Priority Group 2 (HR)* V2 Oct 2025 | `on_asthma_cyp_reg_pg2_hr_v2_oct_2025_vs10` |  | SCT Const | 1 | Bambuterol Hydrochloride | 42efbe32 |
| On Asthma(CYP) Register- LTC LCS Priority Group 2 (HR)* V2 Oct 2025 | `on_asthma_cyp_reg_pg2_hr_v2_oct_2025_vs11` |  | SCT_PREP | 28 | Atimos Modulite 12micrograms/dose inhaler (Chiesi Ltd), Foradil 12microgram i... | f9bf039c |
| On Asthma(CYP) Register- LTC LCS Priority Group 2 (HR)* V2 Oct 2025 | `on_asthma_cyp_reg_pg2_hr_v2_oct_2025_vs12` |  | SCT Const | 6 | Beclometasone Dipropionate, Budesonide, Ciclesonide +3 more | a2d6b25c |
| On Asthma(CYP) Register- LTC LCS Priority Group 2 (HR)* V2 Oct 2025 | `on_asthma_cyp_reg_pg2_hr_v2_oct_2025_vs2` |  | SNOMED | 1 | Child on protection register | d9a584fb |
| On Asthma(CYP) Register- LTC LCS Priority Group 2 (HR)* V2 Oct 2025 | `on_asthma_cyp_reg_pg2_hr_v2_oct_2025_vs3` |  | SNOMED | 2 | Child in need, Child no longer in need | 8332ea34 |
| On Asthma(CYP) Register- LTC LCS Priority Group 2 (HR)* V2 Oct 2025 | `on_asthma_cyp_reg_pg2_hr_v2_oct_2025_vs4` |  | SNOMED | 1 | Child in need | 17e62b70 |
| On Asthma(CYP) Register- LTC LCS Priority Group 2 (HR)* V2 Oct 2025 | `on_asthma_cyp_reg_pg2_hr_v2_oct_2025_vs5` |  | SNOMED | 3 | Emergency hospital admission for asthma, Emergency asthma admission since las... | 7a5550bd |
| On Asthma(CYP) Register- LTC LCS Priority Group 2 (HR)* V2 Oct 2025 | `on_asthma_cyp_reg_pg2_hr_v2_oct_2025_vs6` |  | SNOMED | 39 | Acute exacerbation of asthma, Acute severe exacerbation of asthma, Exacerbati... | ff2958ce |
| On Asthma(CYP) Register- LTC LCS Priority Group 2 (HR)* V2 Oct 2025 | `on_asthma_cyp_reg_pg2_hr_v2_oct_2025_vs7` |  | SCT Const | 3 | Prednisolone, Prednisolone Sodium Phosphate, Prednisolone Steaglate | 153a3cb0 |
| On Asthma(CYP) Register- LTC LCS Priority Group 2 (HR)* V2 Oct 2025 | `on_asthma_cyp_reg_pg2_hr_v2_oct_2025_vs8` |  | SCT Const | 5 | Theophylline, Theophylline Hydrate, Theophylline S/R +2 more | 08d2e32b |
| On Asthma(CYP) Register- LTC LCS Priority Group 2 (HR)* V2 Oct 2025 | `on_asthma_cyp_reg_pg2_hr_v2_oct_2025_vs9` |  | SCT Const | 3 | Salbutamol, Salbutamol Cr, Terbutaline Sulfate | 5c851fb5 |
