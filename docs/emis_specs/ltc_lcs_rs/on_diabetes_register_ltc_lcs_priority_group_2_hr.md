...
Start with the patients found by "LTC LCS: Diabetes Register*" (see below). Patients matching Rule 1 are excluded. A patient is included when they match any one of Rules 2-7.
...
| on Diabetes Register- LTC LCS Priority Group 2 (HR) | `on_dm_reg_pg2_hr_vs1` | IFCCHBAM_COD | SNOMED | 3 | Haemoglobin A1c level - IFCC standardised, HbA1c level (diagnostic reference ... | 95d9e41a |
| on Diabetes Register- LTC LCS Priority Group 2 (HR) | `on_dm_reg_pg2_hr_vs2` |  | SNOMED | 33 | O/E - Right diabetic foot - ulcerated, O/E - Left diabetic foot - ulcerated, ... | 62608eed |
| on Diabetes Register- LTC LCS Priority Group 2 (HR) | `on_dm_reg_pg2_hr_vs3` | CHD_COD | SNOMED | 444 | Mural thrombus of right ventricle following acute myocardial infarction, Post... | e4c73e0d |
| on Diabetes Register- LTC LCS Priority Group 2 (HR) | `on_dm_reg_pg2_hr_vs4` | STRK_COD | SNOMED | 271 | Thrombosis of left middle cerebral artery, Left middle cerebral artery thromb... | bb3a48ed |
| on Diabetes Register- LTC LCS Priority Group 2 (HR) | `on_dm_reg_pg2_hr_vs5` | TIA_COD | SNOMED | 38 | Transient cerebral ischemia, Anterior circulation transient ischaemic attack,... | 8b1f1274 |
| on Diabetes Register- LTC LCS Priority Group 2 (HR) | `on_dm_reg_pg2_hr_vs6` |  | SNOMED | 2 | GFR (glomerular filtration rate) calculated by abbreviated Modification of Di... | 45ee7150 |
| on Diabetes Register- LTC LCS Priority Group 2 (HR) | `on_dm_reg_pg2_hr_vs7` |  | SNOMED | 1 | Urine albumin:creatinine ratio | 71e284a5 |
